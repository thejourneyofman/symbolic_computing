...
void mytensorflow::add_register(std::string a)
{
...
/// Register a new "*" operation to the computing graph
/// :param #1 : operation name
void mytensorflow::mul_register(std::string a)
{
...
/// Register a new "-" operation to the computing graph
/// :param #1 : operation name
void mytensorflow::min_register(std::string a)
{
...
/// Register a new "/" operation to the computing graph
/// :param #1 : operation name
void mytensorflow::div_register(std::string a)
{
...
void mytensorflow::variable(std::string a)
{
...
/// :param #1 : node1 name
/// :param #2 : node2 name
void mytensorflow::tensor(std::string a, std::string b)
{
...
/// :param #2 : input name
void mytensorflow::constant(string a, std::string b)
{
